select
     right(github.[EntitlementAttributes],(len(github.[EntitlementAttributes])-patindex('%product=%',github.[EntitlementAttributes])-7))+' ('+github.[EntitlementOwner1]+')' as 'ResName1',
     '-' as 'ResName2',
     case 
     ...
     (     
        select distinct R1.Application, R1.EntitlementOwner1, R1.EntitlementAttributes, R1.ContactEmail, R1.User_ID 
     ...
     where github.application = 'CA Endevor'